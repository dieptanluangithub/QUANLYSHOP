...
namespace QUANLYSHOP
{
    public class QuanLyNhanVien
    {
        ...
        public void searchNhanVien()
        {
            ...
            Console.Write("     Nhập mã nhân viên của nhân viên bạn muốn tìm: ");
            string m = Console.ReadLine();
        ...
        {
            Console.Write("     NHẬP MÃ NHÂN VIÊN BẠN CẦN TÍNH LƯƠNG: ");
            string m = Console.ReadLine();

            var search = (from nv in Shop.lNhanVien
                          where nv.SMaNV == m
                          select nv).Count();
            if (search == 0)
            {
            ...
            else
            {
                ...
                Console.WriteLine("            Mã NV                       Họ và Tên       ");
                Console.WriteLine("            {0,-20}{1,-25} ", nhanVien.SMaNV, nhanVien.STen);
                Console.WriteLine("     Số ngày đi làm: {0}", nhanVien.ISoNgayLam); 
                Console.WriteLine("     Số giờ tăng ca: {0}", nhanVien.IGioTangCa);
                
                Console.WriteLine("     Tổng lương tháng này: ", (nhanVien as TuVan).LuongTong());
                Console.WriteLine("    ___________________________________________________________");
