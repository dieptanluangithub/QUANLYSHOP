...
namespace QUANLYSHOP
{
    public static class Shop
    {
        ...
        {
            //Hoa don
            DateTime a = new DateTime(2021, 01, 25, 15,46,52);
            HoaDon hd1 = new HoaDon("HD01", a);
            ...
            lHoaDon.Add(hd1);
            //HOA DON 2 
            DateTime b = new DateTime(2021, 1, 26, 08, 16, 03);
            HoaDon hd2 = new HoaDon("HD02", b);
            ...
            //HOA DON 3 
            DateTime c = new DateTime(2021, 1, 26, 15, 10, 59);
            HoaDon hd3 = new HoaDon("HD03", c);
            hd3.LSanphammua = new List<SanPham>();
            hd3.soluongmua = new int[100];

            SanPham sp6 = new Quan("QUAN003", "VIETNAM", 9, "40", "XAM", "QUAN", "KAKI", 490000);
            hd3.LSanphammua.Add(sp6);
            SanPham sp7 = new Quan("QUAN002", "CHINA", 6, "39", "ĐEN", "QUAN", "KAKI", 495000);
            hd3.LSanphammua.Add(sp7);


            hd3.Manv = new ThuNgan("TN01", "Lê Quỳnh Trâm Anh", 1998, "0986978673", "Quận Thủ Đức, Tp.HCM", "251274453", "TN", "Nữ", 28, 10);
            ...
            for (int i = 0; i < hd3.LSanphammua.Count; i++)
            {
                hd3.Tongtien = hd3.Tongtien + hd3.LSanphammua[i].DGiaTien * hd3.soluongmua[i];
            }
            lHoaDon.Add(hd3);
            ...
            // thu ngân
            NhanVien tn1 = new ThuNgan("TN01", "Lê Quỳnh Trâm Anh", 1998, "0986978673", "Quận Thủ Đức, Tp.HCM", "251274453", "TN", "Nữ", 28, 10);
            lNhanVien.Add(tn1);
            NhanVien tn2 = new ThuNgan("TN02", "Nguyễn Đình Thái Ngân", 1997, "0984567673", "Quận Bình Thạnh, Tp.HCM", "256784453", "TN", "Nam", 28,10);
            lNhanVien.Add(tn2);

            // tư vấn
            NhanVien tv1 = new TuVan("TV01", "Cao Mỹ Nhân", 2001, "0987983245", "Quận 2, Tp.HCM", "245274983", "TV", "Nữ", 28,10);
            lNhanVien.Add(tv1);
            NhanVien tv2 = new TuVan("TV02", "Trần Nguyễn Tuấn Anh", 2001, "0935983245", "Quận 3, Tp.HCM", "246274983", "TV", "Nam", 28,10);
            lNhanVien.Add(tv2);
        }
